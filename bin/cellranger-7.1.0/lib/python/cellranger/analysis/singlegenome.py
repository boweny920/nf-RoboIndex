...
from cellranger.analysis.analysis_types import LSA, PCA, PLSA, TSNE, UMAP, DifferentialExpression
...
class SingleGenomeAnalysis:
    def __init__(
        ...
        # DR: n_components -> DR
        self.dimensionality_reduced_matrix: dict[int, Union[PCA, PLSA, LSA]] = {}
        ...
        self.tsne: dict[Union[str, bytes, None], TSNE] = {}

        # UMAP: n_umap components -> UMAP
        self.umap: dict[Union[str, bytes, None], UMAP] = {}
