...
def get_whitelist_name_from_chemistry_description(description: str) -> Union[None, str]:
    """Try to load a chemistry whitelist from a description of a chemistry, returns.
