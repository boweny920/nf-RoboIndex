...
Contact support@10xgenomics.com for additional help with this error."""
        ...
        dense_matrix = cmo_matrix.m.todense().astype(np.float64).T
    ...
    def _compute_no_tag_metric(self, report_prefix="", depth_suffix=""):
        return {
            "{}frac_no_tag_assigned{}".format(
                report_prefix, depth_suffix
            ): self.assignment_metadata.frac_cells_without_features,
            "{}observed_num_no_tag_assigned{}".format(
                report_prefix, depth_suffix
            ): self.assignment_metadata.num_cells_without_features,
            "{}frac_blanks{}".format(
                report_prefix, depth_suffix
            ): self.assignment_metadata.frac_cells_blanks,
            "{}observed_num_blanks{}".format(
                report_prefix, depth_suffix
            ): self.assignment_metadata.num_cells_blanks,
            "{}frac_unassigned{}".format(
                report_prefix, depth_suffix
            ): self.assignment_metadata.frac_cells_unassigned,
            "{}observed_num_unassigned{}".format(
                report_prefix, depth_suffix
            ): self.assignment_metadata.num_cells_unassigned,
        }
