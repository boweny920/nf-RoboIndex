...
from typing import TYPE_CHECKING, Any, Callable, Optional, TextIO, TypedDict, Union, overload
...
def codon_to_aa(codon: Union[str, bytes]) -> int:
...
def find_cdr3_end_motif(j_amino_acids: bytes, allowed_end_motifs: list[str]) -> Optional[int]:
...
@overload
def _bytes_or_none(maybe_str: Union[bytes, str]) -> bytes:
    ...


def _bytes_or_none(maybe_str: Optional[Union[bytes, str]]) -> Optional[bytes]:
...
class AnnotatedContigDict(TypedDict):
    barcode: Optional[Union[bytes, str]]
    contig_name: Any
    sequence: str
    annotations: Iterable[dict[str, Any]]
    clonotype: Any
    is_cell: Optional[bool]
    read_count: Optional[int]
    umi_count: Optional[int]
    info: dict
...
class AnnotatedContig:
    ...
    def __init__(
        ...
        self.barcode: Optional[bytes] = barcode
        self.clonotype = clonotype
        self.read_count: Optional[int] = read_count
        self.umi_count: Optional[int] = umi_count
        ...
        self.cdr3_start: Optional[int] = None
        self.cdr3_stop: Optional[int] = None
        # sequence of CDR3 (self.sequence[cdr_pos[0]:cdr_pos[1]])
        self.cdr3_seq: Optional[bytes] = None
        # CDR3 amino-acid sequence
        self.cdr3: Optional[bytes] = None
        self.cdr3_flag = None
        self.start_codon_pos: Optional[int] = None
        self.stop_codon_pos: Optional[int] = None
        self.frame = None
        self.aa_sequence: Optional[bytes] = None
        self.productive = None
        self.info_dict = info_dict
        # The cell-barcode was called as a cell
        self.is_cell: Optional[bool] = is_cell
    ...
    def clonotype_seq(self) -> Union[tuple[None, None], tuple[bytes, bytes]]:
...
class Annotation:
    ...
    def __init__(
        ...
        contig_match_end: int,
        mismatches,
        contig_seq: Optional[bytes] = None,
    ):
        """Constructor.
    ...
    @classmethod
    def from_alignment_result(cls, alignment_result: SSWAlignmentResult, sequence: Optional[bytes]):
        alignment = alignment_result.alignment
        assert alignment is not None
    ...
    def from_dict(
        ...
        reference: vdj_reference.VdjReference,
        contig_seq: Optional[Union[str, bytes]] = None,
    ) -> Annotation:
        return cls(
