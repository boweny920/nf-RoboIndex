    ...
    "data": [
        [
            ...
            [
                ...
                # "The display is limited to a random subset of spots.", # TODO(Peter Edge) we should set a max # of cells in insitu and subsample if necessary
            ],
        ]
    ],
    "title": "Clustering",
...
def analysis_by_clustering_helper(
    ...
    downsample_mask: Optional[np.ndarray] = None,
):
...
def analysis_by_clustering(
    ...
    if analysis is None:
        return None
    return analysis_by_clustering_helper(analysis, spatial=spatial, library_type=library_type)
