...
class ResourceCollection(React10X):
    ...
    def add_shared_resource(self, item):
        ...
        if cur_items > max_val:
            raise Exception("Limit on total number of shared resources is exceeded.")
        vals = [
...
def write_html_file(filename: Union[str, bytes], websummary_data: WebSummaryData, contents=None):
