...
def join(args, outs, chunk_defs, chunk_outs):
    ...
    shutil.copy(chunk_out.multi_genome_summary, outs.multi_genome_summary)
    shutil.copytree(chunk_out.multi_genome_csv, outs.multi_genome_csv, dirs_exist_ok=True)
    shutil.copytree(chunk_out.multi_genome_json, outs.multi_genome_json, dirs_exist_ok=True)
