...
stage SANITIZE_MAP_CALLS(
    ...
    in  map<path>   in_antigen_analysis,
...
def main(args, outs):
    ...
    outs.antibody_analysis = recursive_hard_link_dict(args.in_antibody_analysis)
    outs.antigen_analysis = recursive_hard_link_dict(args.in_antigen_analysis)
