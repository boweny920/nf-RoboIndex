...
def normalize_by_umi(matrix: CountMatrix) -> Union[csc_matrix, csr_matrix]:
...
def normalize_by_idf(matrix: CountMatrix) -> Union[csc_matrix, csr_matrix]:
...
def summarize_columns(matrix: Union[csc_matrix, csr_matrix]) -> tuple[np.ndarray, np.ndarray]:
