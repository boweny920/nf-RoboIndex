...
class FeatureAssigner:
    ...
    def __init__(
        ...
        feature_type: str,
        assignments: Optional[OrderedDict[bytes, FeatureAssignments]] = None,
        features_per_cell: Optional[dict[bytes, list[bytes]]] = None,
        features_per_cell_table: Optional[pd.DataFrame] = None,
        assignment_metadata: Optional[AssignmentMetadata] = None,
    ):
    ...
    def get_generic_feature_assignment_metrics(
        ...
        name_fr_ce_w_features = report_prefix + "frac_cells_with_{}{}".format(
...
class TagAssigner(FeatureAssigner):
    ...
    def _compute_no_tag_molecules_metric(self, report_prefix=""):
        return {
            "{}frac_no_tag_molecules".format(
                report_prefix
            ): self.assignment_metadata.frac_cells_without_feature_umis
        }
