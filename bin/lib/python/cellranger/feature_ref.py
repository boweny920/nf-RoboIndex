...
class TargetFeatureSets:
    ...
    def __init__(
        self, target_features: Union[None, TargetFeatureSets, dict[str, Iterable[int]]]
    ) -> None:
...
class FeatureReference:  # pylint: disable=too-many-public-methods
    ...
    def __init__(
        ...
        target_features: Union[None, TargetFeatureSets, dict[str, Iterable[int]]] = None,
    ):
    ...
    def from_hdf5(cls, group: h5py.Dataset) -> FeatureReference:
        ...
        def _format_path(path: Union[str, bytes]) -> str:
        ...
        def _h5py_dataset_iterator(
            group: Union[h5py.Group, h5py.Dataset], prefix: str = ""
