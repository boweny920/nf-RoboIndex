...
def _report_genome_agnostic_metrics(
    ...
    d[
        "%s_%s_total_raw_reads_per_filtered_bc"
        % (rna_library.MULTI_REFS_PREFIX, cr_constants.TRANSCRIPTOME_REGION)
    ] = mean_reads_per_cell
    ...
    d[
        "%s_%s_total_conf_mapped_reads_per_filtered_bc"
        % (rna_library.MULTI_REFS_PREFIX, cr_constants.TRANSCRIPTOME_REGION)
...
def load_per_barcode_metrics(per_barcode_metrics_path):
