...
def build_web_summary_html_aggr(filename, sample_properties, gg_id_to_name_map, sample_data_paths):
    ...
    web_sum_data = build_web_summary_data_aggr(
        sample_properties, gg_id_to_name_map, sample_data_paths
    )
    write_html_file(filename, web_sum_data)


def build_web_summary_data_aggr(sample_properties, gg_id_to_name_map, sample_data_paths):
    """Build a web summary file for an AGGR Run.
