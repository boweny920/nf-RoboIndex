...
import os
import resource
from typing import BinaryIO, Callable, Generic, Literal, TextIO, TypeVar, Union, overload

_T_co = TypeVar("_T_co", bound=Union[TextIO, BinaryIO], covariant=True)
...
class FileHandleCache(Generic[_T_co]):
    ...
    def __init__(
        ...
        mode: Literal["w", "r"] = ...,
        open_func: Callable[
            [Union[str, bytes, os.PathLike[str], os.PathLike[bytes]], Literal["w", "r", "a"]],
            TextIO,
        ] = ...,
    ):
        ...
    ...
    def __init__(
        ...
        mode: Literal["wb", "rb"] = ...,
        open_func: Callable[
            [Union[str, bytes, os.PathLike[str], os.PathLike[bytes]], Literal["wb", "rb", "ab"]],
            BinaryIO,
        ] = ...,
    ):
        ...
    ...
    def __init__(
        ...
        self.open_func: Callable[
            [Union[str, bytes, os.PathLike[str], os.PathLike[bytes]], str], _T_co
        ] = open_func
        self.config_max_files()
        self.have_opened: dict[Union[str, bytes, os.PathLike[str], os.PathLike[bytes]], int] = {}
        self.open_files: collections.OrderedDict[
            Union[str, bytes, os.PathLike[str], os.PathLike[bytes]], _T_co
    ...
    def get(self, fn: Union[str, bytes]) -> _T_co:
