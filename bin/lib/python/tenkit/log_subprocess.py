...
def _str_args(args: Union[list[AnyStr], tuple[AnyStr]]) -> list[str]:
...
def check_call(args: list[AnyStr], *wargs: Any, **kwargs: Any) -> int:
...
def call(args: list[AnyStr], *wargs: Any, **kwargs: Any) -> int:
    """See `subprocess.call`."""
    # pylint: disable=no-value-for-parameter
...
def Popen(  # pylint: disable=invalid-name
    args: list[AnyStr], *wargs: Any, **kwargs: Any
...
def pipeline(
    cmds: list[list[AnyStr]],
    stdin: Union[None, str, bytes, IO[bytes]] = None,
    close_input: bool = False,
    stdout: Union[None, str, bytes, IO[bytes]] = None,
...
def _pipeline(
    cmds: list[list[AnyStr]],
    input_file: Union[None, str, bytes, IO[bytes]],
    close_input: bool,
    output_file: Union[None, str, bytes, IO[bytes]],
    close_output: bool,
):
