    ...
    for lib_type in lib_types:
        ...
        for genome in genomes:
            ...
            if genome is not None:
                ...
                summary[
                    "%s%s_filtered_bcs_conf_mapped_barcoded_reads_cum_frac" % prefixes
                ] = frac_reads_in_cells
        ...
        frac_reads_in_cells = tk_stats.robust_divide(flt_reads, raw_reads)
        summary[
            "%s%s_filtered_bcs_conf_mapped_barcoded_reads_cum_frac"
            % (libtype_prefix, rna_library.MULTI_REFS_PREFIX)
        ] = frac_reads_in_cells
