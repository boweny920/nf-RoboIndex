...
def main(args, outs):
    ...
    # https://github.com/10XDev/cellranger/blob/0f7ea9199567a43b8f4240536408b5ad4168253d/lib/python/cellranger/analysis/segment_model_fitter.py#L237-L282
    alpha = 0.02
    ...
    chart = {
        "config": PLOT_CONFIG,
        "layout": {
            "xaxis": {"title": "Spliced Probe Counts (Ln(x+1))"},
            "yaxis": {"title": "Unspliced Probe Counts (Ln(x+1))"},
        },
